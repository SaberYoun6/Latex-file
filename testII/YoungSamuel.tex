...
\part{2.B}
		I orignial thought that there were at least 500 of these genes had a greater than or equal to 2.000 p-value with a degree of freedom of 60, it was any assumption that I made base on the data that was given.  but appearntlty there is closer to 2072 genes a within this p-value range. What is 20 precent a close apporximate to 28 precent. A p-value is a value that is a statistcal test that is shown with $1 - \int_{-\infty}^{cv} \mathrm{f(t)}$. 
